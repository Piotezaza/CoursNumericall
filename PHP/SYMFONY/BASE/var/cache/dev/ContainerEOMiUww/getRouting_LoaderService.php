...
$d->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_class'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotClassService.php')));
$d->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_dir'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotDirService.php')));
$d->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_file'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotFileService.php')));
$d->addLoader($c);
$d->addLoader(new \Symfony\Component\Routing\Loader\AnnotationDirectoryLoader($a, $c));
$d->addLoader(new \Symfony\Component\Routing\Loader\AnnotationFileLoader($a, $c));

return $this->services['routing.loader'] = new \Symfony\Bundle\FrameworkBundle\Routing\DelegatingLoader(($this->privates['controller_name_converter'] ?? $this->privates['controller_name_converter'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser(($this->services['kernel'] ?? $this->get('kernel')))), $d);
